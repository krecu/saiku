        ...
        $.contextMenu({
            ...
            ignoreRightClick: true,
             build: function($trigger, e) {
                ...
                var citems = {
                        "filter" : {name: "Фильтр", items: 
                         { 
                                "customfilter": {name: "Другой..." },
                                "clearfilter": {name: "Очистить фильтр" }
                         }},
                        "limit" : {name: "Лимит", items: 
                        {
                                "TopCount###SEPARATOR###10": {name: "10 сверху" },
                                "BottomCount###SEPARATOR###10": {name: "10 снизу" },
                                "TopCountQuick" : { name: "10 сверху по...", items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: "10 снизу по...", items: addFun(items, "BottomCount") },
                                "customtop" : {name: "Другой лимит..." },
                                "clearlimit" : {name: "Очистить лимит"}
                         }},
                        "sort" : {name: "Сортировка", items:
                        {
                            "ASCQuick": {name: "По убыванию" , items: addFun(items, "ASC") },
                            "DESCQuick": {name: "По возрастанию", items: addFun(items, "DESC")},
                            "BASCQuick": {name: "По убыванию (без иерархии)", items: addFun(items, "BASC")},
                            "BDESCQuick": {name: "По возрастанию (без иерархии)", items: addFun(items, "BDESC") },
                            "customsort" : { name: "Другое..." },
                            "clearsort" : {name: "Очистить сортировку" }
                        }}
                };
